...
<body>
        ...
        <main class="main-content">
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom mb-3 pt-2 pb-2">
                    <h1 class="h2"><i class="fas fa-layer-group me-2"></i>Category Management</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCategoryModal" onclick="openAddModal()">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${category.parentCategoryID != null}">
                                                                <c:forEach var="parentCat" items="${categories}">
                                                                    <c:if test="${parentCat.categoryID == category.parentCategoryID}">
                                                    ...
                                                    <td class="text-end pe-4">
                                                        <div class="d-flex justify-content-end">
                                                            <button class="btn btn-outline-primary btn-sm me-2" 
                                                                    onclick="openEditModal('${category.categoryID}', '${category.categoryName}', '${category.parentCategoryID}')">
                                        ...
                                        <c:otherwise>
                                            <tr>
                                                <td colspan="4" class="text-center py-4">
                                                    <p class="text-muted mb-0">No categories found. Add a new category to get started.</p>
                                                </td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/category?action=insert" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="parentCategoryID" name="parentCategoryID">
                                ...
                                <c:forEach var="parentCat" items="${categories}">
                                    <option value="${parentCat.categoryID}">${parentCat.categoryName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.openEditModal = (categoryId, categoryName, parentCategoryId) => {
            ...
            // Xác nhận xóa
            window.confirmDelete = categoryId => {
                if (confirm('Are you sure you want to delete this category?')) {
                    location.href = '${pageContext.request.contextPath}/category?action=delete&id=' + categoryId;
                }
            };
